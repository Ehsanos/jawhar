                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('cp.edit')}} {{__('cp.slider')}}</span>
                    </div>
                </div>
                                ...
                                <div class="form-group" id="champion">
                                    ...
                                    <div class="col-md-6">
                                        <select id="type" class="form-control "
                                                name="type">
                                            <option value="0" @if(@$item->type == 0 ){{ 'selected' }} @endif>صورة فقط
                                            </option>
                                            <option value="1" @if(@$item->type == 1 ){{ 'selected' }} @endif >منتج
                                            </option>
                                            <option value="2" @if(@$item->type == 2 ){{ 'selected' }} @endif>رابط
                                            </option>
                            ...
                            <fieldset id="link">
                                <div class="form-group">
                                    ...
                                    <div  style="direction: ltr" class="col-md-6">
                                        <input style="direction: ltr" type="url" class="form-control" name="link" value="{{@$item->link}}">
