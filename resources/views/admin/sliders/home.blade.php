        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/sliders/create')}}{{request()->segment("4") != null ? "?my_store_id=".request()->segment("4") :""}}"
                            ...
                            <button class="btn sbold red event" href="#deleteAll" role="button"
                                    data-toggle="modal">{{__('cp.delete')}}
                                <i class="fa fa-times"></i>
                            </button>
                            <a href="{{url(getLocal().'/admin/slider/sorting')}}{{request()->segment("4") != null ? "/".request()->segment("4") :""}}" style="margin-right: 5px"
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                ...
                                <a href="#myModal{{$one->id}}" role="button" data-toggle="modal"
                                   class="btn btn-xs red tooltips" data-placement="top"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="#" onclick="delete_adv('{{$one->id}}','{{$one->id}}',event)">
