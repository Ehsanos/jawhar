                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            ...
                            <td> {{$item->id}}</td>
                            <td> @if($item->store_id == 0) متجر جوهر @else{{$item->store_id}}@endif</td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="#" onclick="openWindow('{{url(getLocal().'/admin/orders/printOrder/'.$item->id)}}')" class="btn btn-xs red tooltips" data-container="body" data-placement="top"
