        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/news/create')}}" style="margin-right: 5px"
                           ...
                           <a href="{{url(getLocal().'/admin/newss/sorting')}}" style="margin-right: 5px"
                ...
                @forelse($items as $one)
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                <a href="#myModal{{$one->id}}" role="button"  data-toggle="modal" class="btn btn-xs red tooltips">
