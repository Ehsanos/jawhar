...
@section('title') {{__('cp.courseRequest')}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/courseRequest')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(app()->getLocale().'/admin/courseRequest')}}" type="submit"
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/courseRequest/'.$item->id.'/edit')}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('cp.edit')}}"><i class="fa fa-edit"></i>
                                </a>
                                
                                
                                <!--<a href="#" onclick="openWindow('{{url(getLocal().'/admin/courseRequest/printOrder/'.$item->id)}}')" class="btn btn-xs red tooltips" data-container="body" data-placement="top"-->
