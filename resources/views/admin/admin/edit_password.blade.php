...
@section('title')  <a href="{{url(getLocal().'/admin/admins/')}}"> {{__('cp.admins')}} </a>   <span class="symbol">/</span>  {{$item->name}}
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/admins/'.$item->id.'/edit_password')}}" enctype="multipart/form-data" class="form-horizontal" role="form">
                    {{ csrf_field() }}
