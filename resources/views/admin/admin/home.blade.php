    ...
    <div class="portlet-body">
        <div class="table-toolbar">
            <div class="row">
                <div class="col-sm-9">
                    <div class="btn-group">
                        <a href="{{url(app()->getLocale().'/admin/admins/create')}}" style="margin-right: 5px" class="btn sbold btn-primary">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{url(app()->getLocale().'/admin/admins')}}" type="submit" class="btn sbold btn-default ">{{__('cp.reset')}}
        ...
        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable1">
            ...
            @forelse($items as $item)
                <tr class="odd gradeX" id="tr-{{$item->id}}">
                    ...
                    <td> {{$item->mobile}}</td>
                    <td> 
                        <span class="label label-sm <?php echo ($item->status == "active") ? "label-info" : "label-danger"?>" id="label-{{$item->id}}">
                            @php
                                $status = $item->status
                            @endphp
                            {{__('cp.'.$status)}}
                    ...
                    <td>
                        <div class="btn-group btn-action">
                            ...
                            <a href="{{url(getLocal().'/admin/admins/'.$item->id.'/edit_password')}}" class="btn btn-xs green tooltips" data-container="body" data-placement="top" data-original-title="{{__('cp.edit_password')}}">
