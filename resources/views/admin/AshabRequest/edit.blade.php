    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <form method="post" action="{{url(app()->getLocale().'/admin/AshabRequest/'.@$AshabRequest->id)}}"
                        ...
                        <div class="form-group" id="gover_option">
                            ...
                            <div class="col-md-3">
                                <select id="multiple2" class="form-control"
                                        name="status">
                                        <option value="0">{{__('cp.complete')}}</option>
                                        <option value="1">{{__('cp.cancel')}}</option>
                                </select>
                                حالة الطلب الحالية :
                                @if(@$AshabRequest->status == 0){{__('cp.complete')}} @endif
                                @if(@$AshabRequest->status == 1){{__('cp.cancel')}} @endif
