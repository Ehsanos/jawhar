        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/games/create')}}" style="margin-right: 5px"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('cp.is_game'))}}</th>
                    <th> {{ucwords(__('cp.min_quantity'))}}</th>
                ...
                @forelse(@$games as $item)
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>{{@$item->name}}</td>
                        <td>{{@$item->city_id == 0 ? __('cp.all') : @$item->city->name}}</td>
                        <td> @if(@$item->is_game_player == 1) {{__('cp.game')}}  @endif</td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/games/'.$item->id.'/edit')}}"
