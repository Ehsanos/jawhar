        ...
        <div class="portlet-body">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @forelse($countries as $country)
                    <tr class="odd gradeX" id="tr-{{$country->id}}">
                        <td>
                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                <input type="checkbox" class="checkboxes chkBox" value="{{$country->id}}" name="chkBox"/>
                                <span></span>
                            </label>
                        </td>
                        ...
                        <td> <span class="label label-sm {{ ($country->status == "active")
                                ? "label-info" : "label-danger"}} " id="label-{{$country->id}}">
                                {{__('cp.'.$country->status)}}
                            </span></td>

                        <td class="center">{{$country->created_at}}</td>

                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/countries/'.$country->id.'/edit')}}"
