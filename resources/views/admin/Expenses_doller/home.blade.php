...
@section('title') {{ucwords(__('مصاريف الدولار'))}}
@endsection
@section('content')
    ...
    <div class="table-toolbar">
        <div class="row">
            <div class="col-sm-9">
                <div class="btn-group">
                    <a href="{{url(getLocal().'/admin/Expenses_dollar/create')}}" style="margin-right: 5px"
            ...
            <tr class="odd gradeX" id="tr-{{$item->id}}">
                ...
                <td>
                    <div class="btn-group btn-action">
                        <a href="{{url(getLocal().'/admin/Expenses_dollar/'.$item->id.'/edit')}}"
