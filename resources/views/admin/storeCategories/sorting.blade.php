...
@section('title') {{__('cp.storeCategories')}}  {{__('cp.sort')}} 
@endsection
@section('css')
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/storeCategories/sort')}}"
                        ...
                        <div class="form-body">
                                    ...
                                    @foreach($items as $item)
                                          <li class="ui-state-default"><span class="idQuantity" data-id="{{$item->id}}"></span>{{$item->name}}</li>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(getLocal().'/admin/storeCategories')}}" class="btn default">{{__('cp.cancel')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
