...
@section('title') {{__('cp.allStoreCategories')}}
@endsection
@section('css')
@endsection
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(app()->getLocale().'/admin/allStoreCategories/create')}}" style="margin-right: 5px" class="btn sbold btn-primary">
                           ...
                           <!--<a href="{{url(getLocal().'/admin/allStoreCategories/sorting')}}" style="margin-right: 5px"-->
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/allStoreCategories/'.$one->id.'/edit')}}"
