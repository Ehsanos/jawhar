        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/promo_codes/create')}}" style="margin-right: 5px"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('cp.percent'))}}</th>
                    <th> {{ucwords(__('cp.max_usage'))}}</th>
                    <th> {{ucwords(__('cp.count_usage'))}}</th>
                ...
                @forelse($items as $item)
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>@if($item->target_type == 1) @lang('cp.product_servic') @elseif($item->target_type == 2) @lang('cp.networks')  @elseif($item->target_type == 3) @lang('cp.game_services') @endif</td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/promo_codes/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        function delete_adv(id, iss_id, e) {
            ...
            var url = '{{url(getLocal()."/admin/promo_codes")}}/' + id;
