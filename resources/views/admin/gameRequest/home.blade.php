        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/gameRequest')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(app()->getLocale().'/admin/gameRequest')}}" type="submit"
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                    ...
                    <tr>
                        ...
                        <th> {{ucwords(__('cp.api_details'))}}</th>
                    ...
                    @forelse($items as $item)
                        <tr class="odd gradeX" id="tr-{{$item->id}}">
                            ...
                            <td class="center"> @if($item->api_id > 0) <span style="color:red;">{{@$item->api->name}}</span> , <span style="color:green;">@lang('cp.id') : {{$item->api_order_id}}</span> , <span style="color:blue;"> @lang('cp.price') : {{$item->api_total_price}} </span> , <span style="color:red;"> @lang('cp.api_status') : {{$item->api_order_status}} </span> @endif </td>
