        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/azkar/create')}}" style="margin-right: 5px"
                           ...
                           <a href="{{url(getLocal().'/admin/azkars/sorting')}}" style="margin-right: 5px"
                    ...
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/azkar/'.$one->id.'/edit')}}"
