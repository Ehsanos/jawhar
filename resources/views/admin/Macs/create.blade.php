        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/mac/store')}}"
                                    ...
                                    <div class="col-md-6">
                                        <select name="person_id" class="form-control" required>
                                            ...
                                            @foreach($Person_mac as $one)
                                                <option value="{{$one->id}}">{{$one->person_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(getLocal().'/admin/mac/store')}}" class="btn default">{{__('cp.cancel')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
