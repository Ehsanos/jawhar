                            ...
                            <fieldset>
                                @foreach($locales as $locale)
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="title_{{$locale->lang}}" value=""
                                                   placeholder=" {{__('cp.title_'.$locale->lang)}}" {{ old('title_'.$locale->lang) }} required>
                                        </div>
                                    </div>
                                @endforeach
                            </fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <textarea class="form-control" name="details_{{$locale->lang}}" value="" id="order"
                                                          ...
                                                          placeholder=" {{__('cp.description_'.$locale->lang)}}" {{ old('description_'.$locale->lang) }} required></textarea>
