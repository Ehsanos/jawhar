...
@section('title') {{__('cp.azkarDetails')}}
@endsection
@section('css')
@endsection
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/azkarDetails/create')}}" style="margin-right: 5px"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('cp.azkar'))}}</th>
                    <th> {{ucwords(__('cp.azkarDetails'))}}</th>
                    <th> {{ucwords(__('cp.repetition'))}}</th>
                ...
                @forelse($items as $one)
                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                        ...
                        <td class="center">{{$one->azkar->name}}</td>
                        <td class="center">{{$one->details}}</td>
                        <td class="center">{{$one->repetition}}</td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/azkarDetails/'.$one->id.'/edit')}}"
