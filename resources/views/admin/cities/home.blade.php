        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/cities/create')}}" style="margin-right: 5px"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @forelse($cities as $city)
                    <tr class="odd gradeX" id="tr-{{$city->id}}">
                        <td>
                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                <input type="checkbox" class="checkboxes chkBox" value="{{$city->id}}" name="chkBox"/>
                                <span></span>
                            </label>
                        </td>
                        ...
                        <td>{{isset($city->country()->id) ? $city->country()->name : ""}}</td>

                        <td> <span class="label label-sm {{ ($city->status == "active")
                                ? "label-info" : "label-danger"}} " id="label-{{$city->id}}">
                                {{__('cp.'.$city->status)}}
                            </span></td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/cities/'.$city->id.'/edit')}}"
