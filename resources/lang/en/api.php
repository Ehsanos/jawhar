...
return [
    'storeAdded' => 'The Store is added But Witting App Admin to approved',
    
     'fail_to_check_payment' => 'Error, Fail to check payment',
     'paymentPending' => 'You have already sent Withdraw request',
    ...
    'end_guess' =>'Sorry , the date for choosing the winner of the tournament is over',

    'ok' => ' Done Successfully !',
    'paymentOk' => ' Your  Payment Request Done Successfully !',
    ...
    'sameCity' => 'the Cart Product s must be the same city',
    ...
    'noBalance'=>'Sorry, You dont have enough Balance ',
    'noCardAvalabil'=>'Sorry, NO Card Avalabil ',
    'noProduct'=>'Sorry, NO Product Avalabil ',
    'noResult'=>'Sorry, NO Result ',
    'addBalanceCard'=>'The balance was added successfully',
    'requestMobileBalance'=>' Mobile Balance request has been sent',
